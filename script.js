...
export const gameDetails = {
  ...
  startingRoomDescription:
    "What you see before you is a large retail golf shop...",
  playerCommands: [
...
let titleistBalls = new Item(
  "titleistBalls",
  "Titleist ballsRoom",
  "balls",
  true
);
let bridgestoneBalls = new Item(
  "bridgestoneBalls",
  "Bridgestone balls",
  "ballsRoom",
  true
);
let practiceBalls = new Item(
  "practiceBalls",
  "Practice balls",
  "ballsRoom",
  false
...
let startingRoom = new Location(
  "startingRoom",
  "Starting Room",
  [sign],
  "clubsRoom"
);
let clubsRoom = new Location(
  "clubsRoom",
  "Clubs Room",
  [driver, hybrid, putter],
  "bagsRoom"
);
let bagsRoom = new Location(
  "bagsRoom",
  "Bags Room",
  [standBag, cartBag, pushCart],
  "clubsRoom, ballsRoom"
);
let ballsRoom = new Location(
  "ballsRoom",
  "Balls Room",
  [titleistBalls, bridgestoneBalls, practiceBalls],
  "accessoriesRoom, bagsRoom, shoesRoom"
);
let accessoriesRoom = new Location(
  "accessoriesRoom",
  "Accessories Room",
  [hat, glove, tees],
  "apparelRoom, ballsRoom"
);
let apparelRoom = new Location(
  "apparelRoom",
  "Apparel Room",
  [belt, shirt, jacket],
  "shoesRoom, accessoriesRoom"
);
let shoesRoom = new Location(
  "shoesRoom",
  "Shoes Room",
  [spikedShoes, spikelessShoes, socks],
  "apparelRoom, ballsRoom"
);
...
//* pickup an item
//? need to check if the item canPickup is true, and if true pickup the item and add to player inventory
...
function drop(itemName) {
  ...
  if (item) {
    ...
    console.log(`User dropped the item: ${itemName}`);
    return `User dropped the item: ${itemName}`;
  } else {
...
function inventoryView() {
  if (inventory.length > 0) {
    const playerItems = inventory.map((item) => item.name);
    console.log(`In your inventory, you have: ${playerItems.join(", ")}`);
    return `In your inventory, you have: ${playerItems.join(", ")}`;
  } else {
